...
from new_batches import *

DATA_DIR = "/home/feng/code_exercise/dataset/simple-examples/gen_data/"
TRAIN_DATA = DATA_DIR + "ptb.train"
EVAL_DATA = DATA_DIR + "ptb.valid"
TEST_DATA = DATA_DIR + "ptb.test"
HIDDEN_SIZE = 300
NUM_LAYERS = 2
VOCAB_SIZE = 10000
TRAIN_BATCH_SIZE = 20
